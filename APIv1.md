...
RESTful API allows to perform trading operations with the following methods:
  ...
  - get user's orders by clientOrderId - [/api/1/trading/order](#ordersByClientOrderId)
  - get trades by clientOrderId - [/api/1/trading/trades/by/order](#usertradesbyorder)
...
### <a name="usertradesbyorder">/api/1/trading/trades/by/order</a>

<i>Summary:</i> returns all trades of specified order (`trade` objects).

<i>Request:</i> `GET /api/1/trading/trades/by/order`
